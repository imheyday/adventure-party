...
abstract contract Adventure is Ownable, IERC721Enumerable {
    ...
    function clearParty() external {
        require(msg.sender == owner() ||
            Adventure(msg.sender).owner() == owner(), "Only owner or owner party");
    ...
    /// ***
    function transferAllFromOtherParty(Adventure otherParty) external onlyOwner {
